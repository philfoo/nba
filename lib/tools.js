...
var tools = {
    ...
    */
    ...
    @return {Number} date in epoch time
    */
    ...
    /*
    Formats the yyyymmdd string and creates a valid Date() object out of it.
    @param {String} date
    ...
    */
    ...
    /*Takes in two epoch time parameters and generates a reddit URL for API call
    @param {Number} startTime in epoch
    @param {Number} endTime in epoch
    @return {String} URL for reddit API
    */
